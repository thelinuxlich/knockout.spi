/** Função que detecta o tipo de variável e aplica o observador correto */
...
/** Função para melhorar a sintaxe de observadores dependentes que suportam escrita */
...
ko.bindingHandlers.jqButton = {
    init: function(element, valueAccessor) {
	    var options = valueAccessor();
	    $(element).button(ko.utils.unwrapObservable(options));
    }
};
